    ...
    <actuator-card :source="source" :refresh="refresh" url="/beans">
        ...
        <template slot="content">
            <v-tabs v-model="tabActive" slider-color="primary">
                <v-tab v-for="tableData of tableDataList" :key="tableData.name" ripple class="primary--text">
                    ...
                    <v-card flat>
                        <v-layout justify-space-between class="filters">
                            <div>
                                ...
                                <button-filter v-for="scope in scopes" :key="scope" :name="scope"
                                               ...
                                               :on-remove="deactivate.bind(this, scopeFilters, scope)"
                                               :color="color(scope)">
                        ...
                        <v-data-table class="table-shadow" :headers="headers" :items="rows" :search="search"
                            ...
                            <template slot="items" slot-scope="props">
                                ...
                                <td>
                                    <v-btn class="v-btn--no-transform" small round :color="color(props.item.scope)">{{
                                        props.item.scope
                                        }}
                                    </v-btn>
                                </td>
