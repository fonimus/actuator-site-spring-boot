...
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, classes = [ActuatorSiteAutoConfigurationVueTest::class])
class ActuatorSiteAutoConfigurationVueTest {
    ...
    fun contextLoads() {
        ...
        assertThat(response.body).contains("[ Vue Boot ]")
    }
